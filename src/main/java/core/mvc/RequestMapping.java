...
import next.controller.qna.UpdateQuestionContorller;
...
public class RequestMapping {
	...
	void initMapping() {
		...
		mappings.put("/qna/updateForm", new ShowUpdateAnswerFormController());
		mappings.put("/qna/update", new UpdateQuestionContorller());
